...
MEDIA_CACHE_TTL_SECONDS = 15 * 60
MEDIA_CACHE_GC_INTERVAL_SECONDS = 5 * 60
MEDIA_CACHE_GC_GRACE_SECONDS = 10 * 60
MEDIA_MIN_VALID_BYTES = 1

ONEBOT_PREFER_LOCAL_VIDEO_DEFAULT = True

QQ_OFFICIAL_MEDIA_THRESHOLD_DEFAULT = 1
