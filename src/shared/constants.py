...
ONEBOT_PREFER_LOCAL_VIDEO_DEFAULT = True
ONEBOT_VIDEO_MAX_BYTES = 100 * 1024 * 1024

QQ_OFFICIAL_MEDIA_THRESHOLD_DEFAULT = 0
# QQ 官方未公开稳定媒体上传上限；这里沿用 2026-05-29 实测结果：
# 除文件外，图片、GIF、视频通过媒体组件上传时超过 10 MiB 容易被网关拒绝。
QQ_OFFICIAL_NON_FILE_MEDIA_MAX_BYTES = 10 * 1024 * 1024
QQ_OFFICIAL_IMAGE_MAX_BYTES = QQ_OFFICIAL_NON_FILE_MEDIA_MAX_BYTES
QQ_OFFICIAL_GIF_MAX_BYTES = QQ_OFFICIAL_NON_FILE_MEDIA_MAX_BYTES
QQ_OFFICIAL_VIDEO_MAX_BYTES = QQ_OFFICIAL_NON_FILE_MEDIA_MAX_BYTES
